            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="col-xs-height col-middle">
                    <div class="text-center">
                        <h1 class="text-white col-sm-12 p-b-10">Blog Posts</h1>
                        <a class="btn btn-sm"  href="/posts/create">Add New Post</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container p-b-50 p-t-50">
        <div class="row">
            ...
            @foreach($posts as $post)
                    <div>
                        <h3 class="text-white col-sm-12 p-b-10"> <em> {{$post->title}}</em> </h3>
                        <a class="btn btn-sm"  href="/posts/{{$post->id}}">View</a>
                        <a class="btn btn-sm"  href="/posts/{{$post->id}}/edit">Edit</a>
                        <a class="btn btn-sm"  href="/posts/{{$post->id}}/delete">Delete</a>
                    </div>
            @endforeach
            </div>
        </div>
